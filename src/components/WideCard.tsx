...
const WideCard = ({
  ...
  return (
    <div
      ...
      className={` rounded-2xl font-SFregular leading-tight ${widthAndHeight}  bg-contain p-7 pt-14 shadow-xl hover:scale-[101%] hover:shadow-xl/15 transition ease-in`}
    >
